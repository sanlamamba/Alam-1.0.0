          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8">
              <div className="main-content-box">
                ...
                <ul className="nav-style1">
                  ...
                  <li>
                    <Link href="/admin/coupons/modal-in-site-loading/">
                      <a className="active">Popup</a>
                    </Link>
                  </li>
                </ul>
                {site ? "Deactiver" : "Activer"} modal after site loading
                <button
                ...
                >
                  {site ? "Deactiver" : "Activer"} <span></span>
                </button>
                <form onSubmit={handleSiteSettings}>
                  ...
                  <input
                    ...
                    required={true}
                  />
                  <div className="form-text">L'image doit etre 700x500!</div>
                  <button
