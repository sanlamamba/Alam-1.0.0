    ...
    <div className="contact-area pb-100">
      <div className="container">
        <div className="section-title">
          <span className="top-title">Contactez-nous</span>
          <h2>
            Nous sommes toujours prêts à vous aider à trouver la bonne solution
          </h2>
        </div>
                ...
                <div className="form-check">
                  <div className="form-group">
                    <div className="form-check">
                      <input
                        name="check"
                        value="J'accepte les conditions et la politique de confidentialité."
