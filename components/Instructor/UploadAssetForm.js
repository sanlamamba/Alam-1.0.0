...
const UploadAssetForm = ({ courseId, onFetchAssets }) => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "lecture_file") {
      ...
      if (fileSize > 5) {
        toast.error("La taille du fichier ne doit pas depasser 5 Mo", {
          style: {
  ...
  const handleAssetUpload = async () => {
    ...
    data.append("upload_preset", cloudinary.file_preset);
      ...
      <div className="row">
        <div className="col-md-6">
          <div className="form-group">
            <label className="form-label fw-semibold">Nom de la leçon</label>
            <input
              type="text"
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <div className="form-text">
              Les fichiers televerser ne doivent pas depasser 5 Mo
            </div>
          </div>
        </div>
