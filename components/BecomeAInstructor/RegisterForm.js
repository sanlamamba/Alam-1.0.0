          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="teacher-register-box">
                {!email_confirmed && (
                  <div className="alert alert-danger" role="alert">
                    ...
                    <a href="/send-confirmation-email">
                      Vous n'avez pas recu de code de confirmation?
                    </a>
                  </div>
                )}
                ...
                {instructor_request && (
                  <div className="alert alert-danger" role="alert">
                    Vous avez deja envoyé une demande d'instructeur.{" "}
                  </div>
                )}
                <h2>Devenir un instructeur</h2>
                <p>
                  Votre adresse email ne sera pas partagée avec des tiers.
