        ...
        <div className="sidebar-futcher">
          <div className="sidebar-title d-flex justify-content-between">
            <h2>
              ...
              {course.before_price > 0 && <del>{course.before_price} Fcfa</del>}
            </h2>
            {course.before_price > 0 && <p>Offre du jour</p>}
          </div>
          ...
          <ul>
            <li>
              <div className="d-flex justify-content-between align-items-center">
                <span>
                  <i className="ri-tv-line"></i> Classe en direct
                </span>
                {course.is_class ? (
            ...
            <li>
              ...
              Ressources
              <span>
                {course.assets && course.assets.length} Telechargeable
                {course.assets && course.assets.length > 1 && "s"}
              </span>
            </li>
            <li>
              ...
              Inscrits
              <span>
                {course.enrolments && course.enrolments.length} Inscrit
                {course.enrolments && course.enrolments.length > 1 && "s"}
              </span>
            </li>
            <li>
          ...
          <div className="coupon">
            <h4 onClick={() => setApplyCoupon(!apply)}>Code promo</h4>
            {apply && (
