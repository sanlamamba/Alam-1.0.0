    ...
    <div>
      {call ? (
        <Jutsu
          ...
          roomName={room}
          displayName={name}
          onMeetingEnd={() => console.log("La classe est terminée")}
        ...
        <form className="row row-cols-lg-auto g-3 align-items-center">
          ...
          <div className="col-12">
            <button onClick={handleClick} type="submit" className="default-btn">
              <i className="flaticon-user"></i> Commencer / Rejoindre la classe
            </button>
          </div>
        </form>
      )}
